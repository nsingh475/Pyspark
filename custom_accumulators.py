## Accumulators are used to gather values across partitions (which run in parallel)
## By default Pyspark supports only int and float accumulators.
## Below we are creating custom accumulators so that we can accumulate values as Dictionary, Set and List
